...
from backend.app.service import ScreenerStore, query


def test_query_filters_and_paginates(monkeypatch):
    frame = pd.DataFrame([
        {"Symbol":"AAA","Company Name":"AAA Ltd","Industry":"Finance","Rank":1,"Momentum Score":90.0,"3M Return":20.0},
        {"Symbol":"BBB","Company Name":"BBB Ltd","Industry":"IT","Rank":2,"Momentum Score":80.0,"3M Return":5.0},
        {"Symbol":"CCC","Company Name":"CCC Ltd","Industry":"Finance","Rank":3,"Momentum Score":70.0,"3M Return":-2.0},
    ])
