...
FILTERABLE = ["Rank", "Index", "Symbol", "CMP", "Momentum Score", "Score Percentile", "Setup", "Rank \u03941M", "Rank \u03943M", "Max DD 12M", "% 200 DMA", "Market Cap", "PE", "ROE", "Debt", "Price to Book", "Dividend Yield", "Promoter Holding %", "Delivery %", "EPS Growth Qtr %", "Sales Growth Qtr %", "NSE Sector", "Basic Industry", "Industry Relative", "Acceleration", "1M Return", "3M Return", "6M Return", "9M Return", "12M Return", "3M Sharpe", "6M Sharpe", "% From 52W High", "% EMA 50", "% EMA 100", "% EMA 200", "Persistence 6M %", "Volume Ratio", "Industry", "Within 20% of 52W High", "Data Age Days"]
SORTABLE = ["Rank", "Symbol", "Company Name", "Industry", "Index", "CMP", "Momentum Score", "Score Percentile", "Setup", "Rank \u03941M", "Rank \u03943M", "Max DD 12M", "% 200 DMA", "Market Cap", "PE", "ROE", "Debt", "Price to Book", "Dividend Yield", "Promoter Holding %", "Delivery %", "EPS Growth Qtr %", "Sales Growth Qtr %", "NSE Sector", "Basic Industry", "Industry Relative", "Acceleration", "1M Return", "3M Return", "6M Return", "9M Return", "12M Return", "3M Sharpe", "6M Sharpe", "% From 52W High", "% EMA 50", "% EMA 100", "% EMA 200", "Persistence 6M %", "Volume Ratio", "Data Age Days"]
